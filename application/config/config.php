...
$config['sess_cookie_name'] = 'parbonErp';
$config['sess_samesite'] = 'Lax';
$config['sess_expiration'] = 7200;
$config['sess_expire_on_close'] = TRUE;
$config['sess_encrypt_cookie'] = TRUE;
$config['sess_save_path'] = APPPATH.'parbonErp/';
...
/* project details */
$config['project_title'] = 'PARBON ERP ™ - 2024 Edition | Cludo Technology Consultants';
$config['project_name'] = 'HOS ERP';
$config['project_short_name'] = 'ERP';
$config['footer_text'] = 'Copyright &copy; '.date('Y');
$config['footer_version'] = '1.1.1';
$config['parent_url'] = 'https://cludocloud.com/';
$config["cnci_address"] = 'Module - 23, Phase - II, Webel IT Park Durgapur - 713208';
$config["cnci_contact"] = "033 3506 0600, Ext -1001";
$config["cnci_email"] = "abhishek.bose@cludotechnology.in";